...
urlpatterns = [
    # Incident reporting
    path("incident-reporting/", views.incident_reporting_system, name="incident_reporting_system",),
    path("report/new/", views.IncidentReportWizard.as_view(wizard_forms), name="submit_incident_report",),
    path("incidents/", views.incident_report_list, name="incident_report_list"),
    path("incidents/<int:pk>/", views.incident_report_detail, name="incident_detail"),
    path("report/success/", views.incident_report_success, name="incident_report_success",),
    path("report/pdf/<int:pk>/", views.incident_report_pdf, name="incident_report_pdf",),
    path("incidents/", views.incident_report_list, name="incident_report_list",),
