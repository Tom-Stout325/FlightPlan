...
class Equipment(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="equipment_items", null=True, blank=True,)
    ...
    faa_certificate              = models.FileField(upload_to=registration_upload_path,   validators=[FileExtensionValidator(ALLOWED_FILE_EXTENSIONS)], blank=True, null=True,)
    ...
    receipt                      = models.FileField(upload_to=receipt_upload_path,   validators=[FileExtensionValidator(ALLOWED_FILE_EXTENSIONS)], blank=True, null=True,)
